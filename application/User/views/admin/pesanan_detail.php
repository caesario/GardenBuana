          ...
          <div class="card-header">
            <div class="row">
              <div class="col-6">
                ...
                <p class="my-0 gb-font-small">TRX-X2TH<?= $detail_pesanan['id_pesanan']; ?></p>
              </div>
              <div class="col-6">
                <button class="btn btn-primary btn-sm float-right ml-1 rounded-0">Cetak Pesanan<i class="ml-2 fas fa-print"></i></button>
                <button class="btn btn-sm btn-danger float-right rounded-0">Batalkan Pesanan</button>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col mt-5">
                ...
                <p class="my-0 gb-font-small px-5 text-justify"><?= $detail_pesanan['keterangan']; ?></p>
              </div>
            </div>
          </div>
        </div>
