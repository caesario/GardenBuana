...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/img/logobaru.jpg'); ?>" rel="icon">
  <link href="<?= base_url('assets/img/logobaru.jpg'); ?>" rel="apple-touch-icon">
  ...
  <link href="<?= base_url('assets/css/temp-style.css'); ?>" rel="stylesheet">
