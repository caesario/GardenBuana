...
<body>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                ID Pesanan #: <?= $invoice['id_pesanan']; ?><br>
                                Tanggal : <?= $invoice['create_date_bayar']; ?><br>
                                <!-- Due: February 1, 2015 -->
                            </td>
                        </tr>
                    </table>
            ...
            <tr class="item">
                <td>
                    Jasa Vendor Taman Hias - <b><?= $invoice['nama_vendor']; ?></b>
                </td>
            ...
            <tr class="total">
                ...
                <td>
                    Total: Rp. <?= number_format($invoice['harga'], 0, ".", ".") ?>,-
                </td>
            </tr>
        </table>
    </div>
