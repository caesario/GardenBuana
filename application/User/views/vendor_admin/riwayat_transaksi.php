      ...
      <tbody>
        <?php foreach ($trx_pesanan as $data) : ?>
          <tr>
            ...
            <td>
              <span>
                <a class="btn btn-success btn-sm py-0 gb-btn-width" href="<?= site_url('transaksi/detail_riwayat'); ?><?= $data['id_pesanan']; ?>" data-toggle="tooltip" data-placement="top" title="Lihat Detail">
