  ...
  <div class="container wow fadeInUp mt-5">
    <section class="bg-white px-5 py-4 rounded-0">
      ...
      <div class="card rounded-0">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-6">
              <button class="btn btn-sm btn-primary gb-btn-order float-right rounded-0 ml-1">Rp. 5.000.000</button>
            </div>
          </div>
      ...
      <div class="mt-4 mb-5">
        ...
        <h3 class="display-6 mb-3">Rp. 5.000.000,-</h3>
      ...
      <div class="mt-4 pt-1">
        <h6 class="font-weight-bold mb-2">Konfirmasi Bukti Pembayaran</h6>
        <input type="file" class="form-control-file btn-sm gb-font-small mb-3" id="gambarPesanan" name="gambarPesanan">
        <p class="gb-font-small mb-2">Keterangan</p>
        <textarea name="" id="" cols="40" rows="3" class="gb-font-small mb-1"></textarea>
        <br>
